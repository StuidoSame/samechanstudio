...
const ko: DeleteAccountMessages = {
  ...
  form: {
    eyebrow: "DELETE REQUEST", title: "삭제 요청 작성", intro: "현재 웹사이트에서 확인된 계정 삭제 지원 앱은 EVRUNE입니다. 비밀번호, 인증번호 또는 신분증 정보는 입력하지 마세요.",
  ...
  scope: {
    eyebrow: "DATA SCOPE", title: "삭제 및 보관 범위", deletedTitle: "삭제 대상으로 처리하는 정보", deleted: ["EVRUNE 계정 기록", "Apple, Google, Kakao 또는 LINE에서 제공된 최소 계정 식별 정보와 로그인 상태", "SAME STUDIO 서버에 보관된 계정 연결 EVRUNE 기록과 설정(있는 경우)"],
  ...
  inApp: { eyebrow: "REQUEST CHANNEL", title: "웹에서 요청", text: "현재 별도로 확인된 EVRUNE 앱 내부 삭제 경로는 안내하지 않습니다. 이 공개 페이지에서 요청 메일을 작성해 전송해주세요." },
  faq: { eyebrow: "FAQ", title: "자주 묻는 질문", items: [
    ...
    { question: "어떤 정보가 삭제되나요?", answer: "확인된 EVRUNE 계정, 최소 로그인 식별 정보와 SAME STUDIO 서버의 계정 연결 기록을 대상으로 합니다. 실제 보유 정보에 따라 범위가 달라질 수 있습니다." },
    { question: "일부 데이터만 삭제할 수 있나요?", answer: "현재 확인된 절차는 계정 및 연결 데이터 전체 삭제입니다. 별도 범위가 필요하면 추가 확인 사항에 적어 문의해주세요." },
    { question: "소셜 로그인 계정도 삭제되나요?", answer: "아닙니다. EVRUNE 연결 정보만 대상으로 하며 Apple, Google, Kakao 또는 LINE 계정 자체는 삭제하지 않습니다." },
...
const ja: DeleteAccountMessages = {
  ...
  inApp: { eyebrow: "REQUEST CHANNEL", title: "ウェブから依頼", text: "現在、確認済みのEVRUNEアプリ内削除経路は別途案内していません。この公開ページでメールを作成して送信してください。" },
  faq: { ...en.faq, title: "よくある質問", items: [ { question: "アプリを削除するとアカウントも削除されますか？", answer: "いいえ。アプリと一部の端末内データは消えても、サーバーのアカウントが残る場合があります。このページから別途依頼してください。" }, { question: "どの情報が削除されますか？", answer: "確認されたEVRUNEアカウント、最小限のログイン識別情報、SAME STUDIOが保有する関連記録が対象です。実際の保有状況により異なります。" }, { question: "一部のデータだけ削除できますか？", answer: "確認済みの手順はアカウントと関連データの全削除です。別の範囲は任意欄に記載してください。" }, { question: "ソーシャルログインのアカウントも削除されますか？", answer: "いいえ。EVRUNEとの接続情報だけが対象で、Apple、Google、Kakao、LINEのアカウント自体は削除されません。" }, { question: "購入履歴も削除されますか？", answer: "ストアの決済・購入履歴はAppleまたはGoogleが管理し、この依頼では削除されません。" }, { question: "処理にはどのくらいかかりますか？", answer: "本人確認後に順次処理します。確認内容や法的保管義務により異なるため、未確認の固定期間は案内しません。" }, { question: "削除したデータは復元できますか？", answer: "削除済みのアカウントと関連データは復元できない場合があります。必要な記録は依頼前に確認してください。" }, { question: "メールアプリが開かない場合は？", answer: "contact@samestudio.krへアプリ名、登録メール、ログイン方法、削除依頼を直接送ってください。パスワードや認証コードは送らないでください。" } ] },
...
const zhCN: DeleteAccountMessages = {
  ...
  form: { ...en.form, title: "填写删除申请", intro: "目前本网站确认支持账号删除的应用仅为 EVRUNE。请勿输入密码、验证码或身份证件信息。", app: "应用", email: "注册邮箱", login: "登录方式", loginPlaceholder: "请选择", requestType: "申请类型", fullDeletion: "删除账号及全部关联数据", message: "补充信息（可选）", messagePlaceholder: "仅填写核验账号所需的信息，请勿输入密码或验证码。", consent: "我已了解账号删除完成后相关数据可能无法恢复，并申请删除上述账号。", privacyNotice: "填写的邮箱、应用、登录方式和申请内容仅用于处理删除申请及身份核验。申请记录依照隐私政策和适用法律保留。", privacyLink: "隐私政策", submit: "提交删除请求", submitting: "正在打开邮件应用…", errors: { app: "请选择应用。", email: "请输入有效的邮箱地址。", login: "请选择实际使用的登录方式。", consent: "必须同意删除及无法恢复提示。", required: "此项为必填项。", submitFailed: "无法提交您的申请。", retry: "请重试。" }, draftReady: "删除申请邮件草稿已准备好。", draftInstruction: "必须在邮件应用中完成发送，申请才会被接收。仅停留在此页面不会发送申请或完成删除。", reference: "参考编号", maskedEmail: "确认邮箱", directEmail: "邮件应用未打开？contact@samestudio.kr", mailAria: "向 contact@samestudio.kr 发送账号删除申请", subject: "[SAME STUDIO] 账号删除申请" },
  scope: { ...en.scope, title: "删除与保留范围", deletedTitle: "进入删除流程的信息", deleted: ["EVRUNE 账号记录", "Apple、Google、Kakao 或 LINE 提供的最低限度账号标识与登录状态", "SAME STUDIO 服务器中与账号关联的 EVRUNE 记录和设置（如有）"], retainedTitle: "可能不会立即删除的信息", retained: ["依法必须保留的记录", "防止滥用与保障安全所需的有限记录", "在技术备份周期内暂时保留的副本"], localTitle: "设备及第三方数据", localText: "仅保存在设备上的数据可能需要通过卸载应用或设备设置另行删除。本申请不会删除 Apple、Google、Kakao、LINE 账号本身，也不会删除应用商店购买记录。" },
  ...
  inApp: { eyebrow: "REQUEST CHANNEL", title: "通过网页申请", text: "目前没有另行列出经确认的 EVRUNE 应用内删除路径。请在此公开页面生成并发送申请邮件。" },
  faq: { ...en.faq, title: "常见问题", items: [ { question: "卸载应用会删除账号吗？", answer: "不会。卸载可能移除应用和部分本地数据，但服务器账号可能仍然存在，请在此单独申请。" }, { question: "哪些信息会被删除？", answer: "经确认的 EVRUNE 账号、最低限度登录标识和 SAME STUDIO 持有的账号关联记录属于申请范围，具体取决于实际持有情况。" }, { question: "可以只删除部分数据吗？", answer: "目前确认的流程为删除账号及全部关联数据。如需其他范围，请在补充信息中说明。" }, { question: "社交登录账号也会被删除吗？", answer: "不会。仅处理与 EVRUNE 的关联，Apple、Google、Kakao 或 LINE 账号本身不会被删除。" }, { question: "购买记录也会被删除吗？", answer: "商店付款和购买记录由 Apple 或 Google 管理，不会通过本申请删除。" }, { question: "处理需要多长时间？", answer: "身份核验后依次处理。时间会因核验及法律保留义务而异，因此不提供未经确认的固定期限。" }, { question: "删除的数据可以恢复吗？", answer: "删除后的账号及相关数据可能无法恢复，请在申请前确认所需记录。" }, { question: "邮件应用无法打开怎么办？", answer: "请直接发送邮件至 contact@samestudio.kr，注明应用、注册邮箱、登录方式和删除请求。切勿发送密码或验证码。" } ] },
...
const zhTW: DeleteAccountMessages = {
  ...
  inApp: { eyebrow: "REQUEST CHANNEL", title: "透過網頁申請", text: "目前沒有另行列出經確認的 EVRUNE 應用程式內刪除路徑。請在此公開頁面產生並傳送申請郵件。" },
  faq: { ...zhCN.faq, title: "常見問題", items: [ { question: "移除應用程式會刪除帳號嗎？", answer: "不會。移除可能刪除應用程式和部分本機資料，但伺服器帳號可能仍然存在，請在此另行申請。" }, { question: "哪些資訊會被刪除？", answer: "經確認的 EVRUNE 帳號、最低限度登入識別和 SAME STUDIO 持有的帳號關聯記錄屬於申請範圍，具體取決於實際持有情況。" }, { question: "可以只刪除部分資料嗎？", answer: "目前確認的流程為刪除帳號及全部關聯資料。如需其他範圍，請在補充資訊中說明。" }, { question: "社群登入帳號也會被刪除嗎？", answer: "不會。僅處理與 EVRUNE 的關聯，Apple、Google、Kakao 或 LINE 帳號本身不會被刪除。" }, { question: "購買記錄也會被刪除嗎？", answer: "商店付款和購買記錄由 Apple 或 Google 管理，不會透過本申請刪除。" }, { question: "處理需要多久？", answer: "身分核驗後依序處理。時間會因核驗及法律保留義務而異，因此不提供未經確認的固定期限。" }, { question: "刪除的資料可以復原嗎？", answer: "刪除後的帳號及相關資料可能無法復原，請在申請前確認所需記錄。" }, { question: "郵件應用程式無法開啟怎麼辦？", answer: "請直接傳送郵件至 contact@samestudio.kr，註明應用程式、註冊電子郵件、登入方式和刪除申請。切勿傳送密碼或驗證碼。" } ] },
