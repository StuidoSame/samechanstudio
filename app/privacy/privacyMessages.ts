...
const ko = {
  ...
  deletion: {
    label: "계정 및 데이터 삭제 안내 →", ariaLabel: "계정 및 데이터 삭제 요청 페이지로 이동", subject: "[SAME STUDIO] 개인정보 삭제 요청",
    body: "앱 이름:\n\n계정 또는 식별 정보:\n\n요청 내용:\n\n추가 확인 사항:\n",
  },
...
const en: PrivacyMessages = {
  ...
  deletion: { label: "ACCOUNT & DATA DELETION →", ariaLabel: "Open the account and data deletion request page", subject: "[SAME STUDIO] Data Deletion Request", body: "App name:\n\nAccount or identifier:\n\nRequest details:\n\nAdditional information:\n" },
...
const ja: PrivacyMessages = {
  ...
  deletion: { label: "アカウントとデータの削除 →", ariaLabel: "アカウントとデータの削除依頼ページを開く", subject: "[SAME STUDIO] 個人情報削除のリクエスト", body: "アプリ名：\n\nアカウントまたは識別情報：\n\n依頼内容：\n\n追加確認事項：\n" },
...
const zhCN: PrivacyMessages = {
  ...
  deletion: { label: "账号与数据删除 →", ariaLabel: "打开账号与数据删除申请页面", subject: "[SAME STUDIO] 个人信息删除请求", body: "应用名称：\n\n账号或识别信息：\n\n申请内容：\n\n补充确认事项：\n" },
...
const zhTW: PrivacyMessages = {
  ...
  deletion: { label: "帳號與資料刪除 →", ariaLabel: "開啟帳號與資料刪除申請頁面", subject: "[SAME STUDIO] 個人資料刪除請求", body: "應用程式名稱：\n\n帳號或識別資訊：\n\n申請內容：\n\n補充確認事項：\n" },
